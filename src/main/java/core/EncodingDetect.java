...
public class EncodingDetect {
     ...
     * @return 文件的编码
     */
	public static String getJavaEncodeByFilePath(String filePath){
	    return getJavaEncodeByFile(new File(filePath));
	}
	 ...
	 * @return
	 */
	public static String getJavaEncodeByFile(File file){
